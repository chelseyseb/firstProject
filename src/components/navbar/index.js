          ...
          <div className="flex flex-wrap items-center justify-between h-20 ">
            <div className="flex flex-wrap justify-between">
              ...
              <div className="flex flex-col pl-2 lg:flex">
                <span className="hidden font-serif text-sm font-bold text-red-800 lg:flex text-medium hover:underline">
                  POLYTECHNIC UNIVERSITY OF THE PHILIPPINES
                </span>
                <div className="display column">
                  <span className="hidden mt-0 font-serif text-sm font-bold text-gray-400 lg:flex text-slate-600">
                    ...
                    <Form>
                      <div className="flex lg:flex lg:pl-24 xl:pl-64 ">
                        <Field
                          ...
                          className="flex hidden h-6 p-0 text-xs font-thin border rounded-sm flex-end lg:flex w-36 search"
                        />
                        <button
                          disabled
                          className="flex flex-wrap content-center justify-center hidden w-6 h-6 text-white bg-red-800 rounded-r-sm lg:flex"
                        >
                          <svg
              ...
              <div className="bg-white">
                <ul className="mt-2">
                  ...
                  <li>
                    <a
                      href="#services"
                      className="flex items-center justify-between px-2 py-4 text-sm transition duration-300 hover:bg-green-500 hover:text-white"
                    >
                      <span>ACADEMIC</span>
                      <svg
                        className="w-4 h-4 text-gray-600"
