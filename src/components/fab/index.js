...
const FloatingActionButtons = () => {
  ...
  const [ShowModal, setShowModal] = useState(isHomepage)
  ...
  return (
    <>
      {(isHomepage || showButtonModal) && ShowModal && (
        <div
        tabindex="-1"
          className="fixed top-0 bottom-0 left-0 right-0 z-50 flex items-center justify-center w-full px-4 mt-10 mb-10 opacity-1"
        >
          <link
            rel="stylesheet"
          ...
          <div  className="relative items-center justify-center overflow-y-scroll lg:h-fit lg:overflow-hidden modal-bg">
